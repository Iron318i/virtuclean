...
<div class="section1" style="background-image:url(<?php echo get_field("oldpage_section1_background"); ?>);">
    <div class="container">
        <div class="row">
...
<div class="section2">
    <div class="container">
        <div class="row">
            <div class="vplayer">
		<?php echo str_replace('frameborder="0"', '', get_field("oldpage_video")); ?>
            </div>
        </div>
    </div>
</div>
...
<div class="section4 oldpage_order_form" style="background-image:url(<?php echo get_field("oldpage_section4_background"); ?>);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="content">
