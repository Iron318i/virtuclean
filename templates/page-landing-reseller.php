<?php
/* Template Name: Landing Redeller Template */
?>
<!DOCTYPE html>
<?php
	...
	<div class="row">
		...
		if (isset($item) && !empty($item)) {
			...
			<ul class="item-mobil">
			    ...
			    <li><?php echo $value['item-text'] ?></li>
			</ul>
			<?php
		    }
		}
...
<section id="quantity" class="quantity" style="background-image: url(<?php echo get_field('quantity-background')['url'] ?>);">
	...
	<div class="row">
	    ...
	    <a href="#form" class="contact-to-buy">contact to buy</a>
	</div>
    </div>
</section>
<section id="sanitizers" class="sanitizers">
	...
	<div class="row">
	    ...
	    <a href="https://www.virtuclean.com/compare-products/" class="view-more">view more</a>
	</div>
    </div>
...
<section id="video" class="video" style="background-image: url(<?php echo get_field('video-background')['url'] ?>);">
	...
	<div class="row">
	    ...
	    <p><?php the_field('video-description') ?><a href="#">www.virtuclean.com</a></p>
	    <div class="l_iframe" id="l_video"><div class="video_bg"></div>
		<iframe src="<?php echo get_field('video-iframe') ?>" width="1140" height="315" allow="autoplay; fullscreen" allowfullscreen="" title="How to use VirtuCLEAN 2.0"></iframe>
...
<section id="form" class="form" style="background-image: url(<?php echo get_field('form-background')['url'] ?>);">
	...
	<div class="row">
     ...
     <a href="#" class="form-send">Send</a> -->

		<?php echo do_shortcode('[contact-form-7 id="1553" title="Landing-Form"]'); ?>
